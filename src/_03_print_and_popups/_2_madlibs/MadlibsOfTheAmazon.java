...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Enter Adjective Here");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Enter Type of Liquid Here");
		// Get the player to enter a body part
		String body_part = JOptionPane.showInputDialog("Enter Body Part Here");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter Verb Here");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Enter Place Here");
